...
class DigitalKnowledgeResources:
    ...
    async def register_rag_session(self,
                                 session_id: str,
                                 user_id: str,
                    ...
                    if resource_id in self.resources:
                        ...
                        if resource['type'] == 'knowledge_item':
                            ...
                            resource_summary.update({
                                ...
                                'knowledge_items_used': resource.get('knowledge_items_used', [])
                            })
        ...
        try:
            ...
            for resource_id in user_resource_ids:
                if resource_id in self.resources:
                    ...
                    analytics['resource_types'][resource_type] = analytics['resource_types'].get(resource_type, 0) + 1
                    ...
                    if resource_type == 'knowledge_item':
                        ...
                        analytics['knowledge_stats']['embedding_models'][embedding_model] = \
                            analytics['knowledge_stats']['embedding_models'].get(embedding_model, 0) + 1
            ...
            if knowledge_text_lengths:
                analytics['knowledge_stats']['avg_text_length'] = sum(knowledge_text_lengths) / len(knowledge_text_lengths)
            
            if context_usage:
                analytics['rag_session_stats']['avg_context_used'] = sum(context_usage) / len(context_usage)
            ...
            if user_documents:
                analytics['document_stats']['avg_chunks_per_document'] = user_document_chunks / len(user_documents)
