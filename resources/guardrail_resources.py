...
class GuardrailConfig:
    ...
    def __init__(self):
        ...
        self.medical_keywords = [
            ...
            "medical history", "doctor", "physician", "hospital", "clinic"
        ]
        
        self.compliance_rules = {
            "hipaa": {
                "description": "Health Insurance Portability and Accountability Act",
                "prohibited": ["patient names", "medical record numbers", "health plan beneficiary numbers"],
                "required_actions": ["anonymize", "redact", "encrypt"]
            },
            "gdpr": {
                "description": "General Data Protection Regulation", 
                "prohibited": ["personal identifiers", "location data", "biometric data"],
                "required_actions": ["consent verification", "data minimization", "right to deletion"]
            },
            "pci": {
...
class GuardrailChecker:
    ...
    def apply_guardrails(self, text: str, compliance_mode: str = "strict") -> Dict[str, Any]:
        ...
        if pii_check["has_violations"]:
            ...
            # Basic sanitization
            for pii_type, pattern in self.config.pii_patterns.items():
                sanitized_text = re.sub(pattern, f"[REDACTED_{pii_type.upper()}]", sanitized_text, flags=re.IGNORECASE)
...
def register_guardrail_resources(mcp: FastMCP):
    ...
    def get_sample_check() -> str:
        ...
        sample_text = "Contact John Doe at 555-123-4567 or john.doe@example.com for patient medical records."
