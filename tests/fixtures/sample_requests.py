...
def sample_embedding_request(
    text: str = "Sample text for embedding",
...
def sample_prompt_list_request(
    cursor: str = None
) -> Dict[str, Any]:
...
def sample_prompt_get_request(
    prompt_name: str = "assistant_prompt",
    arguments: Dict = None
) -> Dict[str, Any]:
    ...
    return mcp_request("prompts/get", {
        "name": prompt_name,
        "arguments": arguments
    })
...
def sample_resource_list_request(
    cursor: str = None
) -> Dict[str, Any]:
...
def sample_resource_read_request(
    uri: str = "resource://data/sample"
) -> Dict[str, Any]:
    """Create sample resources/read request."""
    return mcp_request("resources/read", {
        "uri": uri
    })


def sample_resource_subscribe_request(
    uri: str = "resource://data/sample"
) -> Dict[str, Any]:
    """Create sample resources/subscribe request."""
    return mcp_request("resources/subscribe", {
        "uri": uri
    })
...
def sample_tool_search_request(
    query: str = "analyze data",
    limit: int = 5
) -> Dict[str, Any]:
    """Create sample tool search request."""
    return sample_search_request(
        query=query,
        limit=limit,
        category="tool"
    )
...
def sample_semantic_search_request(
    query: str = "I need to process images",
    limit: int = 10,
    min_score: float = 0.5
) -> Dict[str, Any]:
...
def sample_auth_request(
    api_key: str = "mcp_test_api_key_12345"
) -> Dict[str, str]:
...
def sample_sync_request(
    ...
    return {
        "force": force,
        "collections": collections or ["tools", "prompts", "resources"]
    }
...
def sample_progress_subscribe_request(
    operation_id: str = "op_12345"
) -> Dict[str, Any]:
...
def sample_progress_status_request(
    operation_id: str = "op_12345"
) -> Dict[str, Any]:
...
def create_batch_tool_calls(
    tool_name: str,
    arguments_list: List[Dict]
) -> List[Dict[str, Any]]:
    """Create multiple tool call requests."""
    return [
        sample_tool_call_request(tool_name, args)
