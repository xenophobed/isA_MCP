...
Subscription service implementation using Repository pattern
Focused on subscription business logic with data access through Repository layer
"""
...
class SubscriptionService(BaseService):
    """Subscription service using Repository pattern"""
    ...
    def __init__(self, subscription_repository: SubscriptionRepository = None, 
        ...
        Args:
            subscription_repository: Subscription data repository
            user_repository: User data repository
        """
        super().__init__("SubscriptionService")
