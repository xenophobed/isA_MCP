...
try:
    ...
    from tensorflow.keras.layers import Dense, Dropout, BatchNormalization, LSTM, GRU, Conv1D, MaxPooling1D
    from tensorflow.keras.utils import to_categorical
    from sklearn.preprocessing import StandardScaler, LabelEncoder
    TENSORFLOW_AVAILABLE = True
except ImportError:
    TENSORFLOW_AVAILABLE = False
    logging.warning("TensorFlow not available. Deep learning capabilities will be limited.")
...
try:
    ...
    logging.warning("PyTorch not available. PyTorch-based models will be disabled.")
