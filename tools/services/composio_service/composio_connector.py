...
class ComposioService(BaseService):
    ...
    def _log_tool_invocation(self, tool_name: str, success: bool, error: Optional[str] = None):
        ...
        if success:
            ...
            logger.error(
                f"Failed to invoke tool '{tool_name}' on service '{self.service_name}': {error}"
            )
    ...
    async def discover_capabilities(self) -> Dict[str, List[str]]:
        ...
        # Define resources
        resources = ["connected_accounts", "available_apps", "app_schemas", "integration_status"]
        ...
        for resource_name in resources:
            self.available_resources[resource_name] = self._create_resource_definition(
                resource_name
            )
        ...
        return {"tools": all_tools, "resources": resources, "prompts": prompts}
    ...
    def _create_tool_definition(self, tool_name: str) -> Dict[str, Any]:
        ...
        app_specific_patterns = {
            ...
            "slack_send_message": {
                ...
                "parameters": {"channel": "Slack channel", "message": "Message content"},
    ...
    async def _handle_list_integrations(self, params: Dict[str, Any]) -> Dict[str, Any]:
        ...
        try:
            ...
            app_list = [
                {
                    "name": getattr(toolkit, "name", str(toolkit)),
    ...
    async def _handle_get_connected_accounts(self, params: Dict[str, Any]) -> Dict[str, Any]:
        ...
        try:
            ...
            connections = (
                connections_response.items if hasattr(connections_response, "items") else []
            )
            ...
            if app_name:
                connections = [
                    ...
                    if getattr(conn, "appUniqueId", getattr(conn, "app_name", None)) == app_name
                ]
    ...
    async def _handle_execute_action(self, params: Dict[str, Any]) -> Dict[str, Any]:
        ...
        try:
            ...
            action_result = self.composio_client.actions.execute(
                action_name=f"{app_name}_{action_name}", params=action_params, entity_id="default"
            )
