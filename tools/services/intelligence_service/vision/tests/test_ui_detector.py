...
from tools.services.intelligence_service.vision.ui_detector import UIDetector, UIDetectionResult, detect_ui_with_coordinates, annotate_ui_elements
...
class TestUIDetector:
    ...
    async def test_annotate_ui_elements_function(self):
        ...
        try:
            annotated_path = await self.detector.annotate_ui_elements(
                screenshot=screenshot_path
            )
