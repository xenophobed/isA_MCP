...
def register_memory_tools(mcp: FastMCP):
    ...
    async def store_factual_memory(
        user_id: str, dialog_content: str, importance_score: float = 0.5
    ) -> str:
        ...
        try:
            ...
            result = await client.store_factual_memory(
                user_id=user_id, dialog_content=dialog_content, importance_score=importance_score
            )
    ...
    async def store_working_memory(
        user_id: str, dialog_content: str, ttl_seconds: int = 3600, importance_score: float = 0.5
    ) -> str:
    ...
    async def search_memories(
        ...
        try:
            ...
            return json.dumps(
                tools.create_response(status="success", action="search_memories", data=result)
            )
    ...
    @security_manager.security_check
    @security_manager.require_authorization(SecurityLevel.LOW)
    async def search_facts_by_subject(user_id: str, subject: str, limit: int = 10) -> str:
        ...
        try:
            ...
            return json.dumps(
                tools.create_response(
                    status="success", action="search_facts_by_subject", data=result
                )
            )
    ...
    @security_manager.security_check
    @security_manager.require_authorization(SecurityLevel.LOW)
    async def search_episodes_by_event_type(user_id: str, event_type: str, limit: int = 10) -> str:
        ...
        try:
            ...
            return json.dumps(
                tools.create_response(
                    status="success", action="search_episodes_by_event_type", data=result
                )
            )
    ...
    @security_manager.security_check
    @security_manager.require_authorization(SecurityLevel.LOW)
    async def search_concepts_by_category(user_id: str, category: str, limit: int = 10) -> str:
        ...
        try:
            ...
            return json.dumps(
                tools.create_response(
                    status="success", action="search_concepts_by_category", data=result
                )
            )
    ...
    async def get_session_context(
        user_id: str, session_id: str, include_summaries: bool = True, max_recent_messages: int = 5
    ) -> str:
        ...
        try:
            ...
            return json.dumps(
                tools.create_response(status="success", action="get_session_context", data=result)
            )
    ...
    async def summarize_session(
        user_id: str, session_id: str, force_update: bool = False, compression_level: str = "medium"
    ) -> str:
    ...
    async def get_active_working_memories(user_id: str) -> str:
        ...
        try:
            ...
            return json.dumps(
                tools.create_response(
                    status="success", action="get_active_working_memories", data=result
                )
            )
    ...
    async def get_memory_statistics(user_id: str) -> str:
        ...
        try:
            ...
            return json.dumps(
                tools.create_response(status="success", action="get_memory_statistics", data=stats)
            )
    ...
    async def memory_health_check() -> str:
        ...
        try:
            ...
            return json.dumps(
                tools.create_response(status="success", action="memory_health_check", data=health)
            )
            ...
            return json.dumps(
                tools.create_response(
                    status="error", action="memory_health_check", data={}, error_message=str(e)
                )
            )
