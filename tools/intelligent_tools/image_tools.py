#!/usr/bin/env python3
"""
Image Tools - MCP tools wrapper for AI image generation
AI-powered image generation and transformation tools

Tools provided:
- generate_image: Create images from text descriptions or transform existing images
"""
...
from tools.intelligent_tools.img.image_intelligence_service import AtomicImageIntelligence
...
class ImageTools(BaseTool):
    """Image generation tools using Atomic Image Intelligence"""
    ...
    def register_tools(self, mcp: FastMCP):
        ...
        self.register_tool(
            ...
            name="generate_image",
            description="""Generate create make produce images pictures photos artwork using AI.

Creates new images from text descriptions. Generate images of people, animals, objects, scenes.
...
def register_image_tools(mcp: FastMCP):
    ...
    logger.debug("Image generation tools registered successfully")
    return tool
